...
import { ChevronDown, Dot, Mail, Pencil, Phone } from "lucide-react";

export default function CientUpcomingSceduleDetails() {
  return (
    <div className="min-h-60 flex flex-col gap-y-4 pb-20">
      ...
      <div className="flex justify-between w-full min-h-80 gap-x-4">
        <div className="w-full lg:w-1/2 bg-[#F8F9FA] p-5">
          {/* --------Assigned details------- */}
          <div className="w-full flex flex-col gap-y-3 px-2 mt-2 mb-10">
            <div className="w-full flex items-center justify-between">
              <h4 className="text-base font-medium">Assigned Clients</h4>
            </div>
            <div className="flex flex-col gap-y-4">
              {/* contact 1 */}
              <div className="mt-2">
                <h4 className="text-base font-medium">Jane Doe</h4>
